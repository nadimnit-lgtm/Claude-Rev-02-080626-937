...
(function () {
  ...
  var DEFAULTS = {
    theme: "dark-ambient",
    arabicScript: "indopak",          // indopak (Nastaliq, default) | naskh (Scheherazade)
  ...
  var I18N = {
    en: {
      ...
      vQuran:"Qur\u2019an", vHadith:"Hadith \u2014 source cited", vCompilation:"Traditional \u2014 unverified"
    },
    ur: {
      ...
      vQuran:"\u0642\u0631\u0622\u0646", vHadith:"\u062D\u062F\u06CC\u062B \u2014 \u062D\u0648\u0627\u0644\u06C1 \u062F\u0631\u062C", vCompilation:"\u0631\u0648\u0627\u06CC\u062A\u06CC \u2014 \u063A\u06CC\u0631 \u0645\u0635\u062F\u0642\u06C1"
    }
  };
  function t(k) {
  ...
  function bindGlobal() {
    ...
    $("#viewPick").addEventListener("click", function () { openSheet("#sectionSheet"); });
  ...
  function buildSettings() {
    ...
    disp.appendChild(segRow("Arabic script", "Indo-Pak Nastaliq for a traditional feel, or Naskh for maximum clarity.", "arabicScript",
      [["Indo-Pak", "indopak"], ["Naskh (clear)", "naskh"]]));
    ...
    pr.appendChild(segRow(t("location"), t("locationDesc"), "city",
      [["Automatic", "auto"], ["Riyadh", "riyadh"], ["Jeddah", "jeddah"], ["Makkah", "makkah"], ["Madinah", "madinah"], ["Dammam", "dammam"]]));
    body.appendChild(pr);
    ...
    about.innerHTML =
      ...
      '<br>Indo-Pak Arabic uses Noto Nastaliq Urdu; Naskh uses Scheherazade New (both SIL OFL). ' +
